...
Shader "MicroSplat/Culdesac-Terrain"
{
   Properties
   {
   ...
   SubShader
   {
            Tags {"RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "12"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Culdesac-Terrain_Base-628176217"
   Fallback "Hidden/MicroSplat/Culdesac-Terrain_Base-628176217"
