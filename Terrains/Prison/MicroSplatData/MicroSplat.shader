...
Shader "MicroSplat/Prison-Terrain" {
   Properties {
   ...
   SubShader {
      Tags{ "RenderType" = "Opaque"  "Queue" = "Geometry+100" "SplatCount" = "12"}
      Cull Back
      ZTest LEqual
      CGPROGRAM
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "Hidden/MicroSplat/Prison-Terrain_Base263420527"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Prison-Terrain_Base263420527"
